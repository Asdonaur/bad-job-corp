...
public class scrCntrlInGame : MonoBehaviour
{
    ...
    //                           0                        1                                       2                                                         3                               4                               5
    string[] perderRazones = { "Por culpa del debug",    "El jefe te vio sin hacer nada",           "Ignorancia hacia los compañeros",                      "Dormir en el trabajo",         "Ataque de locura",             "Inactividad" };
    string[] perderConsejos = { "No uses hacks",         "No dejes de trabajar si el jefe te ve",   "No trabajes cuando quien sea menos el jefe te vea",    "Cuida tu barra de energia",    "El café en exceso es malo",    "La barra de despido sube un poco cuando no haces nada"};
    ...
    void Despido()
    {
        ...
        motivoText.text = "MOTIVO PRINCIPAL:\n" + perderRazones[perderMotivo];
        consejoText.text = " CONSEJO:\n" + perderConsejos[perderMotivo];
        puntosLoseText.text = "PUNTUACIÓN:\n" + puntaje;
